...
def boar_brawl(player_score, opponent_score):
    ...
    return max(3 * abs(ones_digit - tens_digit), 1)
    # END PROBLEM 2
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    res_boar = boar_brawl(score, opponent_score)
    if res_boar >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    res_sus = sus_update(0, score, opponent_score)
    if res_sus - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if sus_update(0, score, opponent_score) >= 100:
        ...
        return sus_strategy(score, opponent_score, 9)
    # END PROBLEM 12
